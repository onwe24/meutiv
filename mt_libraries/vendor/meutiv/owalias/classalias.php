...
if( defined('MT_DIR_USERFILES')){
    define('OW_DIR_USERFILES', MT_DIR_USERFILES);
}

if( defined('MT_DIR_LIB')){
    define('OW_DIR_LIB', MT_DIR_LIB);
}

if( defined('MT_DIR_PLUGIN')){
    define('OW_DIR_PLUGIN', MT_DIR_PLUGIN);
}
